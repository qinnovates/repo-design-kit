<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="docs/assets/header-v3.svg">
    <source media="(prefers-color-scheme: light)" srcset="docs/assets/header-light.svg">
    <img alt="Repo Design Kit" src="docs/assets/header-v3.svg" width="400">
  </picture>
</p>
...
**2. Edit the SVG header** — change the title text in `docs/assets/header-v3.svg` and `header-light.svg`:
...
<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="docs/assets/header-v3.svg">
    <source media="(prefers-color-scheme: light)" srcset="docs/assets/header-light.svg">
    <img alt="Project Name" src="docs/assets/header-v3.svg" width="700">
  </picture>
</p>
...
repo-design-kit/
├── docs/assets/
│   ├── header-v3.svg              # Generated SVG header (dark mode)
